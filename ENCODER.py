...
"MODIFICATION","DOCUMENT","CONTENT","MESSAGE","COMMAND",
"PROCESSING","ENCODING","DECODING","COMPILER","INTERPRETER",
"SCHEDULER","MONITOR","HANDLER","MANAGER","CONTROLLER",
"CONNECTOR","DESCRIPTOR","PROCESSOR","COLLECTION","STRUCTURE",
"COMPONENT","ATTRIBUTE","ELEMENT","INSTANCE","REFERENCE",
"SEQUENCE","OPERATOR","OPERAND","EXPRESSION","STATEMENT",
"CONDITION","ITERATION","RECURSION","ALGORITHM","PROCEDURE",
"VARIABLES","PARAMETERS","FUNCTIONS","SERVICES","RESOURCES",
"PERMISSIONS","CREDENTIALS","POLICY","SESSIONID","TRANSPORT",
"PROTOCOL","ENCRYPTION","DECRYPTION","SIGNATURE","VALIDATION",
"AUTHORITY","DIRECTORY","REGISTRY","CATALOG","REPOSITORY",
"ARCHIVE","BUFFER","STREAM","PIPELINE","CHANNEL","PORT",
"SOCKET","FRAMEWORK","LIBRARY","UTILITY","TOOL","PACKAGEID",
"VERSION","RELEASE","PATCH","UPDATELOG","CHANGELOG","METADATA",
"PAYLOAD","REQUESTID","RESPONSEID","TIMESTAMP","CHECKSUM"
]
