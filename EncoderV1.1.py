...
text = """HELLO WORLD. THIS IS A RANDOM BLOCK OF TEXT WRITTEN USING CAPITAL LETTERS ONLY. THE PURPOSE IS TO TEST THE TOKEN SYSTEM AND SEE HOW WELL THE ENCODER AND DECODER HANDLE NORMAL SENTENCES MIXED WITH RANDOM WORDS. PROGRAM SYSTEM NETWORK MEMORY METHOD OBJECT RESULT VALUE. END OF SAMPLE TEXT."""
